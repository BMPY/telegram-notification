...
* The original package name 'com.telegram-notification-backend' is invalid and this project uses 'com.telegram_notification_backend' instead.
...
* [Liquibase Migration](https://docs.spring.io/spring-boot/docs/3.4.0-SNAPSHOT/reference/htmlsingle/index.html#howto.data-initialization.migration-tool.liquibase)
